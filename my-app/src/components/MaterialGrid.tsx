            ...
            >
              ...
              <div className="relative">
                <img
                  src={cat.image}
                  alt={cat.name}
                  className="w-24 h-24 rounded-full object-cover border-4 border-gray-200 group-hover:border-gray-300 transition-all duration-300 group-hover:scale-110 shadow-lg"
                />
              </div>
              {/* Text */}
